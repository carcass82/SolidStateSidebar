namespace SSS {
    ...
    public class Strings {
        ...
        public static string SettingsAppsColumn1 {
            get {
                return ResourceManager.GetString("SettingsAppsColumn1", resourceCulture);
            }
        }

        public static string SettingsAppsColumn2 {
            get {
                return ResourceManager.GetString("SettingsAppsColumn2", resourceCulture);
            }
        }
        ...
        public static string SettingsMaxDisplayCount {
            get {
                return ResourceManager.GetString("SettingsMaxDisplayCount", resourceCulture);
            }
        }

        public static string SettingsMaxDisplayCountTooltip {
            get {
                return ResourceManager.GetString("SettingsMaxDisplayCountTooltip", resourceCulture);
            }
        }
